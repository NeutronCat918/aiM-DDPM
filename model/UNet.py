...
import torch
import math
from .components import DownSample,Upsample,SinusoidalPosEmb,BlockAttention,ConvNextBlock
...
if __name__ == "__main__":
    img_in = torch.randn(1, 3, 128, 128).to("cuda")
    timestamp_in = torch.randn(1).to("cuda")

    models = [
        OneResUNet(64, channels=1).to("cuda"),
        TwoResUNet(64, channels=1).to("cuda"),
        AttentionUNet(64, channels=1).to("cuda")
    ]
